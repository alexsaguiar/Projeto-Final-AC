        ...
        <div class="linha">
            <section>
                ...
                <div class="coluna col7 contato">
                    ...
                    <form action="Editar_Historico_Servlet" method="post"> 
                        <br>
                        <br>
                        <label>Codigo do Serviço:</label>
                        <input placeholder="verificar codigo" name="codigo_historico" value="<%= historico.codigo_historico%>">
                        <br> 
                       ...
                       <select name="tb_concluido">
                        ...
                        <textarea  name="observacao"><%=historico.observacao%></textarea>
